[![Ensure compliance with Ledger guidelines](https://github.com/blooo-io/app-algorand/actions/workflows/guidelines_enforcer.yml/badge.svg?branch=develop)](https://github.com/blooo-io/app-algorand/actions/workflows/guidelines_enforcer.yml)

[![Build and run functional tests using ragger through reusable workflow](https://github.com/blooo-io/app-algorand/actions/workflows/build_and_functional_tests.yml/badge.svg?branch=develop)](https://github.com/blooo-io/app-algorand/actions/workflows/build_and_functional_tests.yml)
...
This project contains the Algorand app for Ledger Nano S+, Nano X, Flex, Stax, and Gen 5 (Apex_p).
...
*Once the app is approved by Ledger, it will be available in their app store (Ledger Wallet).
...
* Open a terminal and clone `app-algorand` with `git clone git@github.com:blooo-io/app-algorand.git`.
* Open the `app-algorand` folder with VSCode.
...
The Algorand app comes with functional tests implemented with Ledger's [Ragger](https://github.com/LedgerHQ/ragger)
test framework.

### macOS / Windows

To test the app on macOS or Windows, it is recommended to use [Ledger's VS Code extension](#with-vscode)
...
```shell
speculos --model nanosp app/build/nanos2/bin/app.elf
```
